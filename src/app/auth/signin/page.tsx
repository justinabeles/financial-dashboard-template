...
import LottiePlayer from "@/components/utility/Lottie/SigninLottie";

export const metadata: Metadata = {
  title: "TyrAds SignIn Page",
  description: "This is Next.js Signin Page for TyrAds Dashboard",
};
